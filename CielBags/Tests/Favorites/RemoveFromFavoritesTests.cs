...
namespace CielBags.Tests.Favorites
{
    class RemoveFromFavoritesTests : BaseTest
    {
        ...
        public void RemoveFavorites(string email, string password)
        {
